...
## VI. Write at the End
This repo concludes my first two-year Ph.D. work at CMU and I would like to share my code to contribute to the autonomous UAV research community. At the beginning developing process, I truly felt the frustration as an autonomous robot researcher due to the lack of comprehesive development framework. As a result, I hope my code can help some beginner research in this field to smoothly focus on the algorithm/theory design instead of struggling with the software pipeline. Also, this developed framework is not perfect (at all) thus **I am actively looking for collaborators in research and development to improve the UAV/robot autonomy level. Please feel free to reach out for collaboration!**
